        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="img/categories/book-1.png">
                    <div class="categories__text">
                        <h1>Action Books</h1>
                        <p>Action books are a thrill ride from start to finish, packed with adrenaline-fueled adventures and unforgettable heroes. Perfect for readers who crave excitement and fast-paced storytelling, these books will keep you on the edge of your seat with every turn of the page.</p>
                        <a href="#">Shop now</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/book-2.jpg">
                            <div class="categories__text">
                                <h4>Manga Books</h4>
                                <p>358 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/book-3.jpg">
                            <div class="categories__text">
                                <h4>Fantasy Books</h4>
                                <p>273 items</p>
                                <a href="#">Shop now</a>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/book-4.jpg">
                            <div class="categories__text">
                                <h4>Romantic Books</h4>
                                <p>159 items</p>
                                <a href="#">Shop now</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/book-5.jpg">
                            <div class="categories__text">
                                <h4>SC-FI Books</h4>
                                <p>153 items</p>
                                <a href="#">Shop now</a>
        ...
        <div class="row">
                ...
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/ht-1.png" alt="">
                        </div>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/ht-2.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Project Hail Mary</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/ht-3.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>People We Meet on Vacation</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/bs-1.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>One Piece</h6>
                            <div class="rating">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/bs-2.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Ugly Love <br />briefcase</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/bs-3.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Iron Flame</h6>
                            <div class="rating">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
                <div class="trend__content">
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/f-1.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Fullmetal Alchemist</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                    ...
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/f-2.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>Big Little Lies</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                            ...
                            <div class="product__price">$ 20.0</div>
                        </div>
                    </div>
                    <div class="trend__item">
                        <div class="trend__item__pic">
                            <img src="img/trend/f-3.png" alt="">
                        </div>
                        <div class="trend__item__text">
                            <h6>The Name of the Wind</h6>
                            <div class="rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
